...
with st.form("triage_form"):
    ...
    st.markdown("""
    <!-- COLOR2 -->
    <div style="background:#f9dd8a;border:1px solid #dc900d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#f20a0a;color:white;border-radius:8px;
    ...
    with prob_col:
        ...
        st.markdown(bars_html + """
            ...
            <div style="margin-top:20px;background:#e90ee9;border:1px solid #ff0505;
                ...
                <strong>Model:</strong>Model: KNN (k=7) · 102,000 patients · 99.5% accuracy<br>
